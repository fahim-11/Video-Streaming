...
export const CornerDisplayName = ({
  ...
  const qualityStateArray = [
    ...
    {
      label: "Jitter",
      audio: audioStats[0]?.jitter ? `${parseFloat(audioStats[0]?.jitter).toFixed(2)} ms` : "-",
      video: videoStats[0]?.jitter ? `${parseFloat(videoStats[0]?.jitter).toFixed(2)} ms` : "-",
    },
    {
      label: "Packet Loss",
    ...
    {
      label: "Bitrate",
      audio: audioStats[0]?.bitrate ? `${parseFloat(audioStats[0]?.bitrate).toFixed(2)} kb/s` : "-",
      video: videoStats[0]?.bitrate ? `${parseFloat(videoStats[0]?.bitrate).toFixed(2)} kb/s` : "-",
    },
    {
      label: "Frame rate",
      audio: "-",
    ...
    },
    {
      label: "Resolution",
      audio: "-",
      video: videoStats[0]?.size?.width ? `${videoStats[0]?.size?.width}x${videoStats[0]?.size?.height}` : "-",
    },
    {
      label: "Codec",
    ...
    },
    {
      label: "Cur. Layers",
      audio: "-",
      video: videoStats[0]?.currentSpatialLayer === null ? "-" : `S:${videoStats[0]?.currentSpatialLayer || 0} T:${videoStats[0]?.currentTemporalLayer || 0}`,
    },
    {
      label: "Pref. Layers",
      audio: "-",
      video: videoStats[0]?.preferredSpatialLayer === null ? "-" : `S:${videoStats[0]?.preferredSpatialLayer || 0} T:${videoStats[0]?.preferredTemporalLayer || 0}`,
    },
  ];
  ...
  }, [webcamStream, micStream, screenShareStream, updateStats]); // Added updateStats
