...
export function JoiningScreen({
  ...
  useEffect(() => {
    getCameraDevices();
  }, [isCameraPermissionAllowed, getCameraDevices]); // Added dependency

  useEffect(() => {
    getAudioDevices();
  }, [isMicrophonePermissionAllowed, getAudioDevices]); // Added dependency

  useEffect(() => {
    checkMediaPermission();
  }, [checkMediaPermission]); // Added dependency
